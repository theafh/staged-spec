<task_block>
  ...
  <policy>
    ...
    <decision_rules>
      <dimension id="1" name="Index completeness (`architecture.md`)">
      ...
      <dimension id="2" name="Guardrail coverage">
        ...
        <criterion>Guardrail documents contain outcome-focused constraints, with no implementation details leaking in.</criterion>
      ...
      <dimension id="3" name="Dependency graph integrity">
      ...
      <dimension id="4" name="Scope distribution">
      ...
      <dimension id="5" name="Version tier progression">
      ...
      <dimension id="6" name="Feature documentation alignment">
      ...
      <dimension id="7" name="Terminology and cross-file consistency">
